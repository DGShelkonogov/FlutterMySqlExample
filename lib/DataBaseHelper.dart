import 'dart:io';
import 'package:my_sql_example/data/model/address.dart';
...
class DataBaseHelper {
  ...
  Future<void> onInitTable(Database db) async {
    try {
      await db.insert(DataBaseRequest.tableAddress,
          Address(1, 'Russian', 'Moscow', 'Kashtanovaya', '12').toMap());

      var res = await db
          .query(DataBaseRequest.tableAddress, where: "id = ?", whereArgs: [1]);

      await db.update(DataBaseRequest.tableAddress,
